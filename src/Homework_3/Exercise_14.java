...
public class Exercise_14 {
    ...
    public static void main(String[] args) {
        ...
        //  Поиск минимальной и максимальной оценкки в списке
        for (int j : arr) {
        ...
        //  Добавление позици для максимальной и минимальной оценки
        for (int i = 0; i < arr.length; i++) {
            //  Добавление позици для максимальной оценки
            if (arr[i] == maxRating) {
                maxPosition.append(i + 1).append(" ");
            }
            //  Добавление позици для минимальной оценки
            if (arr[i] == minRating) {
                minPosition.append(i + 1).append(" ");
            }
        }
